package com.music.darkmusicplayer.customviews;
...
import com.music.darkmusicplayer.ui.equalizer.EqualizerFragment;
...
//        linePaint.setColor(Color.parseColor("#FFA036"));
    ...
    public AnalogController(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
